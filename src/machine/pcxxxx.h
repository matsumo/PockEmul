...
public:
    ...
    virtual UINT8 in8(UINT16 address,QString sender=QString()){Q_UNUSED(address) Q_UNUSED(sender) return 0;}
    virtual UINT8 out8(UINT16 address,UINT8 value,QString sender=QString()){Q_UNUSED(address) Q_UNUSED(value) Q_UNUSED(sender) return 0;}
    virtual UINT16 in16(UINT16 address,QString sender=QString()){Q_UNUSED(address) Q_UNUSED(sender) return 0;}
    virtual UINT16 out16(UINT16 address,UINT16 value,QString sender=QString()){Q_UNUSED(address) Q_UNUSED(value) Q_UNUSED(sender) return 0;}
