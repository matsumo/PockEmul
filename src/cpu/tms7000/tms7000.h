...
{
public:
    typedef void ( Ctms7000::*opcode_func ) ();
...
//    address_space_config m_io_config;
    ...
    qint8        m_t1_prescaler;     /* Timer 1 prescaler (5 bits) */
    qint16       m_t1_decrementer;   /* Timer 1 decrementer (8 bits) */
...
//    address_space *m_io;
    ...
    void do_interrupt( UINT16 address, UINT8 line );
    void service_timer1();
...
{
public:
    Ctms7020(CPObject *parent, TMS7000_Models mod = TMS7020);
};
...
{
public:
    Ctms7020_exl(CPObject *parent, TMS7000_Models mod = TMS7020_EXL);
};
...
{
public:
    Ctms7040(CPObject *parent, TMS7000_Models mod = TMS7040);
};
...
{
public:
    Ctms70c00(CPObject *parent, TMS7000_Models mod = TMS70C00);
};
...
{
public:
    Ctms70c20(CPObject *parent, TMS7000_Models mod = TMS70C20);
};
...
{
public:
    Ctms70c40(CPObject *parent, TMS7000_Models mod = TMS70C40);
};
