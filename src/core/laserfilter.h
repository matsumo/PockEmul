...
class laserfilter : public QAbstractVideoFilter
{
    friend class laserfilterRunnable;
...
//        QZXing decoder;
    ...
    public:  /// Methods
        explicit laserfilter(QObject *parent = 0);
        virtual ~laserfilter();
...
class laserfilterRunnable : public QObject, public QVideoFilterRunnable
{
    Q_OBJECT

    public:
        explicit laserfilterRunnable(laserfilter * filter);
